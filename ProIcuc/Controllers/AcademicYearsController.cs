...
namespace ProIcuc.Controllers
{
    public class AcademicYearsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcademicYearID,AcademicYearName")] AcademicYear academicYear)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcademicYearID,AcademicYearName")] AcademicYear academicYear)
        {
            if (ModelState.IsValid)
            {
